...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://boyrokey00:db_rajan123@cluster0.4fhuu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = os.environ.get("DATABASE_NAME", "TAF_Rename")
